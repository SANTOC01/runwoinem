...
export const EUROPE_ROUTE_WAYPOINTS: RouteWaypoint[] = [
  ...
  { name: 'Rom',        country: 'IT', lat: 41.890, lon:  12.492, cumulativeKm:  5230, isMilestone: true,  emoji: '🏛️' },
  { name: 'Athen',      country: 'GR', lat: 37.984, lon:  23.728, cumulativeKm:  7330, isMilestone: true,  emoji: '🏺' },
  { name: 'Budapest',   country: 'HU', lat: 47.498, lon:  19.040, cumulativeKm:  9030, isMilestone: false, labelDy: 16 },
  { name: 'Warschau',   country: 'PL', lat: 52.230, lon:  21.010, cumulativeKm:  9810, isMilestone: false },
  { name: 'Helsinki',   country: 'FI', lat: 60.170, lon:  24.935, cumulativeKm: 11410, isMilestone: true,  emoji: '🌲' },
  { name: 'Oslo',       country: 'NO', lat: 59.911, lon:  10.752, cumulativeKm: 12310, isMilestone: true,  emoji: '⛵' },
  { name: 'London',     country: 'GB', lat: 51.507, lon:  -0.128, cumulativeKm: 13910, isMilestone: true,  emoji: '🎡', labelDy: 18 },
  { name: 'Amsterdam',  country: 'NL', lat: 52.370, lon:   4.895, cumulativeKm: 14410, isMilestone: false },
];
